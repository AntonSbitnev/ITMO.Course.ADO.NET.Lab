...
namespace ITMO.Course.ADONet.Lab1.Ex2
{
    public partial class Form1 : Form
    {
        ...
        //string testConnect = @"Provider=SQLOLEDB.1;Integrated Security=SSPI;Persist Security Info=False;Initial Catalog=Northwind;Data Source=DESKTOP-STQ5VDI\SQLEXPRESS";
        public Form1()
        {
            InitializeComponent();
        ...
        private void toolStripMenuItem3_Click(object sender, EventArgs e)
        {
            ...
            {
                connection.Close();
                MessageBox.Show("The database connection closed");
            }
            else
                MessageBox.Show("The database connection is already closed");
        }
