...
namespace ITMO.Course.ADONet.Lab3.Ex3_4
{
    public partial class DBCommand : Form
    {
        ...
        private void btnСозданиетаблицы_Click(object sender, EventArgs e)
        {
            ...
            {
                MessageBox.Show("Таблица SalesPersons уже создана");
            }
            finally 
            {
        ...
        private void btnзапрос_Click(object sender, EventArgs e)
        {
            System.Text.StringBuilder results = new System.Text.StringBuilder();
        ...
        private void btnПроцедураспараметром_Click(object sender, EventArgs e)
        {
            System.Text.StringBuilder results = new System.Text.StringBuilder();
