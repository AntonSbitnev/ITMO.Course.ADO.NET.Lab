...
namespace ITMO.Course.ADONet.Lab7.Ex1
{
    internal class Program
    {
            ...
            static List<Student> students = new List<Student>
        {
           ...
           new Student {First="Elijah", Last="Abramson", ID=113, Scores= new List<int> {64, 78, 73, 46}},
           new Student {First="Aaron", Last="James", ID=114, Scores= new List<int> {89, 94, 94, 59}},
           new Student {First="Cody", Last="Andrews", ID=115, Scores= new List<int> {99, 93, 97, 95}},
           new Student {First="Evan", Last="Kirk", ID=116, Scores= new List<int> {56, 78, 65, 70}},
           new Student {First="Isaac", Last="Molligan", ID=117, Scores= new List<int> {60, 71, 59, 87}},
           new Student {First="John", Last="Nolan", ID=118, Scores= new List<int> {84, 88, 94, 82}},
           new Student {First="Lucas", Last="Pass", ID=119, Scores= new List<int> {90, 93, 86, 93}},
           new Student {First="Luke", Last="Donovan", ID=120, Scores= new List<int> {92, 86, 45, 56}},
        };
